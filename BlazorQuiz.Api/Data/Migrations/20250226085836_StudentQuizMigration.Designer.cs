...
namespace BlazorQuiz.Api.Data.Migrations
{
    ...
    [Migration("20250226085836_StudentQuizMigration")]
    partial class StudentQuizMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorQuiz.Api.Data.Entities.StudentQuizQuestion", b =>
                {
            ...
            modelBuilder.Entity("BlazorQuiz.Api.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsApproved = false,
                            Name = "Admin",
                            PasswordHash = "AQAAAAIAAYagAAAAEAavaU4sOaKqxNeq6eC/M7gRanvFLOaIyybLCUkRb5v9wwXKEAZoI+eYHyq2/dX7Ew==",
                            Phone = "1234567890",
                            Role = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("BlazorQuiz.Api.Data.Entities.StudentQuizQuestion", b =>
                {
                    ...
                    b.HasOne("BlazorQuiz.Api.Data.Entities.StudentQuiz", "StudentQuiz")
                        .WithMany("StudentQuizQuestion")
